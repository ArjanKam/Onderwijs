...
def data_display(timer):
    ...
    # scroll text
    textLengthPixels = len(internetData.data) * 8 - 1
    displayWidthPixels = NUMBER_OF_MODULES * 8
    text = internetData.data
    #print(textLengthPixels, displayWidthPixels, text)
    x = displayWidthPixels
    while x <= textLengthPixels:
